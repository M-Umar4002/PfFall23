...
void getFlight(int arr[][2], int day) {
...
int main(){
	int flights[10][2] = {
		// morning
		{1, 300}, {1, 320}, {0,   0}, {1, 380}, {1, 375},
		// evening
		{0,   0}, {1, 310}, {1, 280}, {0,   0}, {1, 400}
	};
	...
	getPreference(flights);
	printf("Select day (1 - 5): ");
	scanf("%d", &day);

	getFlight(flights, day);
