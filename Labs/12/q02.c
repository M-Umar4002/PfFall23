 ...
 * Date: 28/11/23
 * Description: Reading from a csv file and then printing the lines with the correct table format
 */
...
int main(){
    ...
    (!strcmp(buffer_1, buffer_2)) ? printf("Both files are equal") : printf("Both files are not equal");
